...
│   │   └── api.js
│   ├── App.jsx
│   ├── main.jsx (o index.jsx según Vite/plantilla)
│   └── styles.css
├── index.html
├── package.json
└── README.md
...
Notas﻿
Este frontend está diseñado para la prueba técnica de desarrollador full-stack﻿con foco en simplicidad y diseño mobile-first﻿.
